...
generate_info_tab <- function(current_metrics, timestamp) {
  ...
  cmp_rows <- paste0(
    ...
    info_comparison_row("Governance &amp; ops",
      "TPA-owned; 2030 plan to roughly double the network",
      "Operator fleet caps since 2021",
      "Operator fleet caps; deep bike&ndash;metro integration")
  )
  ...
  paste0(
    ...
    ' Beijing and Shanghai run two of the largest bike share markets on Earth &mdash; each with roughly a million bikes',
    ' and hundreds of millions of trips a year &mdash; and are useful benchmarks for how docked and dockless models',
    ' can serve a city at massive scale.</p>',
    ...
    ' Wikipedia (List of bicycle-sharing systems; Hello Inc.), China.org.cn (2023), Micromobility Industries (2026),',
    ' the Shanghai 2024 Comprehensive Transportation Development Analysis Report, and operator disclosures from',
    ' HelloBike (global-inc.hellobike.com).</p>',

    '<h3 class="section-title">How China built the world&rsquo;s biggest bike share</h3>',
    '<div class="prose">',
    '<p>China pioneered the modern dockless bike share at enormous scale. Mobike launched in Shanghai in 2016 and Ofo,',
    ' founded by Peking University students in 2014, flooded streets with yellow bikes. By 2017 dozens of operators and',
    ' tens of millions of bikes competed across Chinese cities. That boom overshot &mdash; many startups collapsed and',
    ' fleets were retired &mdash; but the survivors consolidated into a handful of deep-pocketed operators: Meituan Bike',
    ' (which bought Mobike for US$2.7B in 2018), DiDi Qingju (launched in Chengdu in 2017), and HelloBike.</p>',
    '<p>HelloBike was founded in 2016 by Yang Lei and Li Kaizhu. Rather than fight Mobike and Ofo head-on in first-tier',
    ' cities, it started in second- and third-tier cities such as Hangzhou, building a technology-driven operation that',
    ' outlasted the bubble. Backed by Ant Group and the Alibaba ecosystem, it rebranded as Hello in 2018 and grew into one',
    ' of China&rsquo;s largest mobility platforms &mdash; shared bikes, e-bikes, battery swapping, and ridesharing &mdash;',
    ' serving 400+ cities with 800M+ registered users and expanding overseas as HelloRide (Singapore, Australia, Malaysia,',
    ' Hong Kong). Today the sector is led by Meituan, Hello, and DiDi Qingju, running alongside city-managed docked systems.',
    ' <a href="https://global-inc.hellobike.com/" target="_blank" rel="noopener">Hello Inc.</a> details its operations on its',
    ' global site.</p>',
    '</div>',
